...
<body>
    ...
    <div class="container">
        <form action="{{ route('reports.store') }}" method="POST">
            ...
            <input type="number" name="total_transaksi" id="total_transaksi" required>

            <label for="total_pendapatan">Total Pendapatan:</label>
            <input type="number" name="total_pendapatan" id="total_pendapatan" step="0.01" required>

            <label for="status_kinerja">Status Kinerja:</label>
            <input type="text" name="status_kinerja" id="status_kinerja" required>
